...
class EnferlaztTime extends HTMLElement {
	...
	get createType(){
		return {
			analog(variation){
				...
				background.src = `img/enferlazt-clockType-${variation}.png`;
				this.appendChild(background);

				this.createNesting.analog.call(this, {
					classTitle: "hours",
					srcImage: "img/enferlazt-hourType-" + variation + ".png"
				});

				this.createNesting.analog.call(this, {
					classTitle: "minutes",
					srcImage: "img/enferlazt-minType-" + variation + ".png"
				});

				this.createNesting.analog.call(this, {
					classTitle: "seconds",
					srcImage: "img/enferlazt-secType-" + variation + ".png"
				});
    ...
    return ['location', 'type', 'variation', 'map', 'title'];
	}
